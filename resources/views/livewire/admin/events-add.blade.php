...
<div class="relative flex sm:py-12">
    <div class="w-full max-w-xl rounded-md sm:outline-black/5 sm:outline-1 sm:shadow-sm mx-auto p-6">
        ...
        <form wire:submit="save">
            <div class="space-y-4 mt-4">
                ...
                />
                @if ($form->img_path)
                    <div class="relative inline-block rounded outline-1 outline-black/5 shadow-sm p-1 overflow-hidden">
                        <img 
                            class="h-36 w-36 object-cover rounded-xs" 
                            src="{{ $form->img_path->temporaryUrl() }}" 
                            alt="Event Image Preview"
                        />
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8 text-nuetral-600 absolute top-0 right-0 p-2 rounded-bl-md bg-white">
