...
<div class="">
    ...
    <x-frontend.c-section class="lg:!max-w-4xl" :gridGap="0">
        ...
        />
        <x-frontend.c-paragraph 
            :class="'text-white/70 text-shadow-sm sm:text-center lg:text-left'"
            :message="'Expect fo feel:'"
        />
        <br>
        <ul class="text-white list-disc list-inside text-md sm:text-center lg:text-left">
