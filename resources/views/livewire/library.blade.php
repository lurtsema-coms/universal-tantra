    ...
    <div class="relative z-10">
        ...
        <x-frontend.c-section class="!py-0 !max-w-3xl">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">
                <x-frontend.c-button 
                    :class="'flex items-center justify-center !font-semibold !font-raleway gap-4 bg-[#8c1717] rounded-2xl sm:!text-[1.3rem]'"
                >
                    View All
                </x-frontend.c-button>
                <x-frontend.c-button 
                    :class="'flex items-center justify-center !font-semibold !font-raleway gap-4 bg-[#2A2A2A] rounded-2xl sm:!text-[1.3rem]'"
                >
